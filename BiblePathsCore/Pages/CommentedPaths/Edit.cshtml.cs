...
{
    public class EditCPModel : PageModel
    {
        private readonly UserManager<IdentityUser> _userManager;
        private readonly BiblePathsCore.Models.BiblePathsCoreDbContext _context;

        public EditCPModel(UserManager<IdentityUser> userManager, BiblePathsCore.Models.BiblePathsCoreDbContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            else
            {
                if (await TryUpdateModelAsync<Path>(
                        pathToUpdate,
                        "Path",
                        p => p.Name, p => p.OwnerBibleId, p => p.Topics))
                {
